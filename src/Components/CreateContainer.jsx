            ...
            <div className="w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4">
                ...
                <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
                    ...
                    <input 
                        ...
                        className="w-full h-full text-lg bg-transparent outline-none border-none placeholder:text-gray-400 text-zinc-700"
                    />
                </div>
                    ...
                    >
                        ...
                        {categories && 
                            categories.map((item) => (
                                <option
                                    key={item.id}
                                    className="text-base border-0 outline-none capitalize bg-white text-zinc-800"
                        ...
                        {!imageAsset ? <>
                            <label className="w-full h-full flex flex-col items-center justify-center cursor-pointer">
                                <div className="w-full h-full flex flex-col items-center justify-center gap-2">
                                    ...
                                    <p className="text-gray-500 hover:text-gray-700">Click Hero to Upload</p>
                                </div>
                                <input
                                    type="file"
                                    name="uploadImage"
